...
if ($userId) {
    ...
    $stmt->execute();
    $stmt->bind_result($idNo, $lastName, $firstName, $midName, $course, $yearLevel, $email, $address, $userImage);
    $stmt->fetch();
    $stmt->close();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        // Update user information in the database with UPLOAD_IMAGE instead of UPLOAD_IMAGE_PATH

...
CREATE TABLE `users` (
  ...
  `UPLOAD_IMAGE_PATH` varchar(255) DEFAULT NULL,
...
INSERT INTO `users` (`STUD_NUM`, `IDNO`, `LAST_NAME`, `FIRST_NAME`, `MID_NAME`, `COURSE`, `YEAR_LEVEL`, `USER_NAME`, `PASSWORD_HASH`, `UPLOAD_IMAGE`, `UPLOAD_IMAGE`, `EMAIL`, `ADDRESS`) VALUES
...
-- Add UPLOAD_IMAGE_PATH column to users table
ALTER TABLE `users`
ADD COLUMN `UPLOAD_IMAGE_PATH` varchar(255) DEFAULT NULL AFTER `UPLOAD_IMAGE`;
